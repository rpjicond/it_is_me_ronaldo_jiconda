...
export const translations = {
    pt: {
        ...
        hero: {
            ...
            role: 'Desenvolvedor Embarcado, IoT & Engenheiro de Redes.',
            sub: 'Concepção de soluções conectadas, do sensor à nuvem.',
            description: 'Licenciatura Profissional em Redes e Telecomunicações, percurso IoT e Mobile. Especialista em conectar o mundo físico ao digital.',
    ...
    en: {
        ...
        hero: {
            ...
            role: 'Embedded Developer, IoT & Network Engineer.',
            sub: 'Designing connected solutions, from sensor to cloud.',
            description: 'Professional Degree in Networks and Telecoms, IoT and Mobile track. Specialist in connecting the physical world to the digital.',
    ...
    fr: {
        ...
        hero: {
            ...
            role: 'Développeur Embarqué, IoT & Ingénieur Réseaux.',
            sub: 'Conception de solutions connectées, du capteur au cloud.',
            description: 'Licence Professionnelle en Réseaux et Télécoms, parcours IoT et Mobile. Spécialiste de la connexion du monde physique au numérique.',
